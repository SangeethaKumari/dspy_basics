...
output_dir = "category_batches_april6"
os.makedirs(output_dir, exist_ok=True)

def load_prompt_from_file(filename="redherringprompt.md"):
    try:    
...
BASE_PROMPT = load_prompt_from_file("redherringprompt.md")
...
if all_files:
    ...
    final_df.to_csv("hackathon_final_200_april6.csv", index=False)
